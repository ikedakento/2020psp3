...
## ソースコードの説明
l68~l77で配列データのインデックスを呼び出して調べる
l78でidがなかった時に-1と出力させる
l89 比較対象の位置をリストの真ん中にする　比較対象と探す値を比較する　結果を入れる
ｌ98　リストの左側を比較対象一の一つ右側にする
ｌ102　リストの右側を比較対象一つ左にする
